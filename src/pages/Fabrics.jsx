...
const allFabrics = [
  {
    ...
    texture_image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=200&h=200&fit=crop",
    color_swatch: "#6B6B6B",
  },
  {
    id: 2,
    ...
    texture_image: "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=200&h=200&fit=crop",
    color_swatch: "#C8B89A",
  },
  {
    id: 3,
    ...
    texture_image: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=200&h=200&fit=crop",
    color_swatch: "#8B7355",
  },
  {
    id: 4,
    ...
    texture_image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=200&h=200&fit=crop",
    color_swatch: "#F5F0E8",
  },
  {
    id: 5,
    ...
    texture_image: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=200&h=200&fit=crop",
    color_swatch: "#4A4A4A",
  },
  {
    id: 6,
    ...
    texture_image: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=200&h=200&fit=crop",
    color_swatch: "#2C3E50",
  },
  {
    id: 7,
    ...
    texture_image: "https://images.unsplash.com/photo-1544022613-e87ca75a784a?w=200&h=200&fit=crop",
    color_swatch: "#7D6B52",
  },
  {
    id: 8,
    ...
    texture_image: "https://images.unsplash.com/photo-1539533018447-63fcce2678e3?w=200&h=200&fit=crop",
    color_swatch: "#1A1A2E",
  },
  {
    id: 9,
    ...
    image: "https://images.unsplash.com/photo-1580657018950-c7f7d6a6d990?w=600&h=600&fit=crop",
    texture_image: "https://images.unsplash.com/photo-1580657018950-c7f7d6a6d990?w=200&h=200&fit=crop",
    color_swatch: "#3C3C3C",
  },
];
...
function FabricCard({ fabric, index }) {
  ...
  return (
    <motion.div
      ...
      className="group bg-white border border-[#EBE4D8] overflow-hidden"
    ...
    >
        ...
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className="absolute inset-0 bg-[#0E2A47]/85 flex flex-col justify-end p-4"
            >
      ...
      <div className="p-5">
        <div className="flex items-start justify-between mb-2">
          <h3 className="font-serif text-lg text-[#0E2A47] leading-tight">{fabric.name}</h3>
          {/* Color swatch dot */}
          <div
